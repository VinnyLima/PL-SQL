...
--REQUISITA O PRIMEIRO E O ULTIMO DIA DO MÊS, PASSANDO COMO PARAMETRO  NUMEROS POSITIVOS PARA MESES A FRENTE DO MÊS VIGENTE OU NEGATIVOS PARA MESES ANTERIORES E ZERO PARA O MÊS ATUAL.
SELECT ADD_MONTHS(trunc(sysdate, 'mm'), -1) AS PRIMEIRO_DIA, ADD_MONTHS(last_day(SYSDATE), 0) AS ULTIMO_DIA FROM DUAL;
